...
The linear correction is important to understand the actual on road concentrations for PM<sub>2.5</sub> collected using DustTrak 8530 in Bangalore. The linear equation can be derived using a gold standard instrument. 
